...
$pdf->Image(ROOTDIR . '/assets/img/' . $logoFilename, 15, 25, 30);
...
if (Lang::trans('languagePDF') == "arabic") 
{

$pdf->SetFont($pdfFont, 'B', 15);
$pdf->SetFillColor(239);
$pdf->Cell(0, 8, $pagetitle, 0, 1, 'R', '1');
$pdf->SetFont($pdfFont, '', 10);
$pdf->Cell(0, 6, Lang::trans('invoicesdatecreated') . ': ' . $datecreated, 0, 1, 'R', '1');
$pdf->Cell(0, 6, Lang::trans('invoicesdatedue') . ': ' . $duedate, 0, 1, 'R', '1');
$pdf->Ln(10);
}
...
$tblhtml = '<table width="100%" bgcolor="#ccc" cellspacing="1" cellpadding="2" border="0">
    <tr height="30" bgcolor="#efefef" style="direction="rtl" font-weight:bold;text-align:center;">
          <td align="center" width="20%">' . Lang::trans('quotelinetotal') . '</td>
        <td align="right" width="80%">' . Lang::trans('invoicesdescription') . '</td>
...
foreach ($invoiceitems as $item) {
    ...
    <tr bgcolor="#fff">
        ...
        <td align="right" direction="rtl">' . nl2br($item['description']) . '<br /></td>
    </tr>';
}
$tblhtml .= '
...
if (Lang::trans('languagePDF') == "arabic") $pdf->setRTL(true);
