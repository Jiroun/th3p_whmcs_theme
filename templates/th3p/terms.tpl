...
{if $language eq 'arabic'}
<h1 style="direction:rtl;text-align:right">{$LANG.terms_title}</h1>

{else}
<h1 style="direction:ltr;text-align:left">{$LANG.terms_title}</h1>
...
<div class="col-sm-12">
    <p>{$LANG.terms_part1}</p>
    <hr>
    <p>{$LANG.terms_part2}</p>
</div>
