        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-4 col-md-3 order-sm-2 order-md-last">
                    <button id="btnResendVerificationEmail" class="btn btn-default btn-sm btn-block btn-resend-verify-email btn-action" onclick="window.location.href='/sendEmailAddressVerification.php'; return false;">
